...
void solve(){
    ...
    if(n%2 == 1 && m%2 == 1){
      q.push(cell(n/2, m/2, n/2 + m/2));
      vis[n/2][m/2] = true;
    }
    else if(n%2 == 0 && m%2 == 0){
      q.push(cell(n/2, m/2, n/2 + m/2));
      vis[n/2][m/2] = true;
      q.push(cell((n-1)/2, (m-1)/2, n/2 + m/2));
      vis[(n-1)/2][(m-1)/2] = true;
      q.push(cell((n-1)/2, m/2, n/2 + m/2));
      vis[(n-1)/2][m/2] = true;
      q.push(cell(n/2, (m-1)/2, n/2 + m/2));
      vis[n/2][(m-1)/2] = true;
    }else{
      if(n%2 == 0){
        q.push(cell(n/2, m/2, n/2 + m/2));
