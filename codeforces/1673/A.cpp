...
void solve(){
    ...
    if(n%2 == 0){
        ...
        int alice1 = a[n-1], bob1 = a[n] - a[n-1];
        int bob2 = a[1], alice2 = a[n] - a[1];

        if(alice1 > bob1 && alice2 > bob2){
            cout << "Alice " << max(alice1 - bob1, alice2 - bob2) << endl;
        }else if(alice1 > bob1){
            cout << "Alice " << alice1 - bob1 << endl;
        }else if(alice2 > bob2){
            cout << "Alice " << alice2 - bob2 << endl;
        }else{
            cout << "Bob " << max(bob1 - alice1, bob2 - alice2) << endl;
        }
    }
}
